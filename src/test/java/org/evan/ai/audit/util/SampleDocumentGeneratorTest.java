...
/**
 * Test class that generates sample audit documents.
 * Run this test to create the sample documents.
 */
class SampleDocumentGeneratorTest {

    private static final String OUTPUT_PATH = "src/main/resources/samples/";

    @Test
    void generateAllSampleDocuments() throws IOException {
        generateTableFormatDocument();
        generateTextFormatDocument();
        generateChineseFormatDocument();
        System.out.println("\n🎉 All sample documents generated in: " + OUTPUT_PATH);
    }

    @Test
    void generateTableFormatDocument() throws IOException {
        String filePath = OUTPUT_PATH + "audit_questionnaire_table.docx";
    ...
    @Test
    void generateTextFormatDocument() throws IOException {
        String filePath = OUTPUT_PATH + "audit_questionnaire_text.docx";
    ...
    @Test
    void generateChineseFormatDocument() throws IOException {
        String filePath = OUTPUT_PATH + "audit_questionnaire_chinese.docx";
